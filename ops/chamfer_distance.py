...
import sys
sys.path.append('D:\OneDrive - The University of Colorado Denver\Registration_Method_3DPhoto\chamfer3D')
...
def chamfer_distance(template: torch.Tensor, source: torch.Tensor):
	try:
		...
		cost_p0_p1, cost_p1_p0,_,_ = chamfer_3DDist()(template, source)
